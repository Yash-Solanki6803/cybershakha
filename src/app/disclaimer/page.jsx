  ...
  return (
    <main className="flex justify-center items-center w-full">
      <div className="mt-40 text-white prose prose-xl prose-neutral prose-headings:text-white prose-p:text-white prose-a:text-brand_primary prose-blockquote:text-slate-400 prose-code:text-green-300 prose-strong:text-brand_primary">
        <h1>Disclaimer for CyberShakha</h1>

        <p>
          If you require any more information or have any questions about our
          site's disclaimer, please feel free to contact us by email at
          thisisyashs@gmail.com.
        </p>

        <h2>Disclaimers for Cybershakha</h2>

        <p>
          All the information on this website - cybershakha.com - is published
          in good faith and for general information purpose only. Cybershakha
          ...
          you find on this website (Cybershakha), is strictly at your own risk.
          Cybershakha will not be liable for any losses and/or damages in
