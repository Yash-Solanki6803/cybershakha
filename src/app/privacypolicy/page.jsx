function PrivacyPolicyPage() {
  return (
    <main className="flex justify-center items-center w-full">
      <div className="mt-40 text-white prose prose-2xl prose-neutral prose-headings:text-white prose-p:text-white prose-a:text-brand_primary prose-blockquote:text-slate-400 prose-code:text-green-300 prose-strong:text-brand_primary">
        <div>
          <div>
            <p>Privacy Policy for Cyber Shakha</p>
          </div>
        </div>
        <div>
          <div>
            <div>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Cyber Shakha
                    CyberSecurity Consultancy Services, Ahmedabad , Gujarat ,
                    India.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Cyber Shakha, accessible
                    from{" "}
                    <a
                      href="cybershakha.com"
              ...
              <ul>
                <li>
                  ...
                  <a
                    href="https://cybershakha.com/#contact"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    cybershakha.com/#contact
                  </a>
                </li>
              </ul>
            </div>
