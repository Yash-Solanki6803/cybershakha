...
function ServiceCard({ src, title, description }) {
  return (
    <div className="border-2 border-transparent h-[60%] lg:w-[30%] bg-glass-gradient object-contain rounded-3xl relative lg:px-4 px-10 lg:py-14 py-2 hover:-translate-y-3 hover:border-brand_primary transition-all duration-150 hover:shadow-lg hover:shadow-slate-700">
