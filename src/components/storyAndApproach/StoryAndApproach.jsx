  ...
  return (
    <section className="flex flex-col items-center min-h-[70vh]">
      ...
      <article className=" py-10 flex flex-col lg:flex-row">
        ...
        <p className="lg:ml-14 lg:mt-0 mt-10 text-justify font-light leading-9 md:text-3xl lg:w-2/3">
      ...
      <article className=" py-10 flex flex-col-reverse lg:flex-row">
        ...
        <h3 className="font-semibold text-center lg:text-right text-5xl text-brand_primary lg:w-1/3">
          Our Approach
        </h3>
      </article>
    </section>
